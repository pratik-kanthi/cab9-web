(function(angular) {
    ...
    moduleCardsController.$inject = ['$scope', 'rData', 'rNavTo', 'rAccessors', '$state', '$interval', '$timeout', '$filter'];

    function moduleCardsController($scope, rData, rNavTo, rAccessors, $state, $interval, $timeout, $filter) {
