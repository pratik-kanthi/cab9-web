(function(angular) {
    ...
    module.controller('DriverItemAdjustmentCreateController', driverItemAdjustmentCreateController);

    driverItemAdjustmentCreateController.$inject = ['$scope', '$stateParams', '$modalInstance', '$rootScope', '$state', '$q', '$config', '$UI', '$http', 'Model', 'rDriverId', 'rTaxes', 'rVehicleTypes'];

    function driverItemAdjustmentCreateController($scope, $stateParams, $modalInstance, $rootScope, $state, $q, $config, $UI, $http, Model, rDriverId, rTaxes, rVehicleTypes) {
        $scope.adjustment = new Model.DriverAdjustment();
        $scope.adjustment.TaxId = $scope.COMPANY.DefaultTaxId;
        $scope.adjustment.DriverId = rDriverId;
        ...
        function save() {
            try {
                if ($scope.adjustment.Recurring != 'Recurring') {
                    $scope.adjustment.AppliesToBooking = false;
    ...
    module.controller('DriverItemAdjustmentEditController', driverItemAdjustmentEditController);

    driverItemAdjustmentEditController.$inject = ['$scope', '$stateParams', '$modalInstance', '$rootScope', '$state', '$q', '$config', '$UI', '$http', 'Model', 'rAdjustment', 'rTaxes', 'rVehicleTypes'];

    function driverItemAdjustmentEditController($scope, $stateParams, $modalInstance, $rootScope, $state, $q, $config, $UI, $http, Model, rAdjustment, rTaxes, rVehicleTypes) {
        $scope.taxes = rTaxes;
