(function() {
    ...
    module.directive('bookingStats', ['$q', '$parse', '$timeout', '$http', '$rootScope', '$UI', 'reports', 'CSV', '$filter',
        function($q, $parse, $timeout, $http, $rootScope, $UI, reports, CSV, $filter) {
            return {
                templateUrl: '/webapp/common/reports/bookings-report/report.bookings.html',
                scope: true,
