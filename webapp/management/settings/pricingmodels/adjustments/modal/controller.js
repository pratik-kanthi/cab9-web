(function(angular) {
    ...
    module.controller('ClientPricingModelAdjustmentCreateController', ClientPricingModelAdjustmentCreateController);

    ClientPricingModelAdjustmentCreateController.$inject = ['$scope', '$stateParams', '$modalInstance', '$rootScope', '$state', '$q', '$config', '$UI', '$http', 'Model', 'rTaxes', 'rVehicleTypes'];

    function ClientPricingModelAdjustmentCreateController($scope, $stateParams, $modalInstance, $rootScope, $state, $q, $config, $UI, $http, Model, rTaxes, rVehicleTypes) {
        $scope.adjustment = new Model.ClientPricingModelAdjustment();
        $scope.adjustment.TaxId = $scope.COMPANY.DefaultTaxId;
        $scope.adjustment.PricingModelId = $stateParams.Id;
    ...
    module.controller('ClientPricingModelAdjustmentEditController', ClientPricingModelAdjustmentEditController);

    ClientPricingModelAdjustmentEditController.$inject = ['$scope', '$stateParams', '$modalInstance', '$rootScope', '$state', '$q', '$config', '$UI', '$http', 'Model', 'rAdjustment', 'rTaxes', 'rVehicleTypes'];

    function ClientPricingModelAdjustmentEditController($scope, $stateParams, $modalInstance, $rootScope, $state, $q, $config, $UI, $http, Model, rAdjustment, rTaxes, rVehicleTypes) {
        $scope.taxes = rTaxes;
