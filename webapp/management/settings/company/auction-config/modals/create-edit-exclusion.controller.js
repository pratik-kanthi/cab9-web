(function(angular) {
    ...
    module.controller('CreateEditExclusionRuleModalController', CreateEditExclusionRuleModalController);

    CreateEditExclusionRuleModalController.$inject = ['$scope', 'rAutomationRule', 'Auth', '$http', 'Model', '$UI', '$modal'];

    function CreateEditExclusionRuleModalController($scope, rAutomationRule, Auth, $http, Model, $UI, $modal) {
        $scope.rule = rAutomationRule;
        ...
        function saveRule() {
            ...
            $scope.exclusionRule.BiddingFilterId = $scope.rule.Id;
