(function (angular) {
    ...
    passengerItemCreateController.$inject = ['$scope', '$state', 'Model', 'rClients', 'rPassengerTags', '$UI', '$q', '$config'];

    function passengerItemCreateController($scope, $state, Model, rClients, rPassengerTags, $UI, $q, $config) {
