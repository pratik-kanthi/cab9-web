(function(angular) {
    ...
    module.controller('DriverItemNotesController', driverItemNotesController);

    driverItemNotesController.$inject = ['$scope', 'rNotes', '$state', '$modal', '$stateParams', '$q', 'Model', '$config', '$UI', 'rStaffs', 'rUsers'];

    function driverItemNotesController($scope, rNotes, $state, $modal, $stateParams, $q, Model, $config, $UI, rStaffs, rUsers) {
        ...
        $scope.notes = rNotes.map(function(item) {
            item.CreationUserName = getUserName(item.CreationUserId);
            item.ModificationUserName = getUserName(item.ModificationUserId);
            return item;
        })
