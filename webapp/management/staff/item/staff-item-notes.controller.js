(function (angular) {
    ...
    module.controller('StaffItemNotesController', staffItemNotesController);

    staffItemNotesController.$inject = ['$scope', 'rNotes', '$state', '$modal', '$stateParams', '$q', 'Model', '$config', '$UI', 'rStaffs', 'rUsers'];

    function staffItemNotesController($scope, rNotes, $state, $modal, $stateParams, $q, Model, $config, $UI, rStaffs, rUsers) {
        $scope.notes = rNotes;
