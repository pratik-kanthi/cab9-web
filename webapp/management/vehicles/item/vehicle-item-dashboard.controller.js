(function (angular) {
    ...
    vehicleItemDashboardController.$inject = ['$scope', '$modal', '$UI', '$config', '$http', '$q', '$filter', 'rData'];
    function vehicleItemDashboardController($scope, $modal, $UI, $config, $http, $q, $filter, rData) {
