(function (angular) {
    ...
    module.controller('VehicleItemNotesController', vehicleItemNotesController);

    vehicleItemNotesController.$inject = ['$scope', 'rNotes', '$state', '$modal', '$stateParams', '$q', 'Model', '$config', '$UI', 'rStaffs', 'rUsers'];

    function vehicleItemNotesController($scope, rNotes, $state, $modal, $stateParams, $q, Model, $config, $UI, rStaffs, rUsers) {
        $scope.notes = rNotes;
